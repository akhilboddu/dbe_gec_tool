              ...
              <div className="px-4 py-5 bg-white sm:p-6">
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-4">
                    <label htmlFor="Title-Id" className="block font-medium text-gray-700 text-md">Test ID</label>
                    <input type="text" name="Title-Id" id="Title-Id" className="border h-[36px] px-2  block w-full mt-1 bg-gray-100 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" {...register("titleId", { required: true })} />
                  </div>

                  <div className="col-span-6 sm:col-span-4">
                    <label htmlFor="Title" className="block font-medium text-gray-700 text-md">Test Title</label>
                    <input type="text" name="Title" id="Title" className="border h-[36px] px-2  block w-full mt-1 bg-gray-100 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" {...register("title", { required: true })} />
                  </div>

                  <div className="col-span-6 sm:col-span-4">
                    <label htmlFor="Title" className="block font-medium text-gray-700 text-md">Teacher's ID</label>
                    <input type="text" name="Title" id="Title" className="border h-[36px] px-2  block w-full mt-1 bg-gray-100 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" {...register("teacherId", { required: true })} />
                  </div>

                  <div className="col-span-6 sm:col-span-4">
                    <label htmlFor="description" className="block font-medium text-gray-700 text-md">Description</label>
                    <input type="text" name="description" id="description" className="border h-[36px] px-2  block w-full mt-1 bg-gray-100 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" {...register("description", { required: true })} />
                  </div>

                  <div className="col-span-6 sm:col-span-4">
                    <label htmlFor="duration" className="block font-medium text-gray-700 text-md">Duration</label>
                    <input type="text" name="duration" id="duration" className="border h-[36px] px-2  block w-full mt-1 bg-gray-100 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" {...register("duration", { required: true })} />
                  </div>
                  </div>
